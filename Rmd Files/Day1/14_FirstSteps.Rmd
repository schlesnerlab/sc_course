...
# Get cutoffs.
counts_lower_cutoff <-  # Minimum amount of UMIs per cell.
genes_lower_cutoff <-  # Minimum amount of genes per cell.
mito_higher_cutoff <-  # Maximum amount of mitochondrial RNA per cell.
