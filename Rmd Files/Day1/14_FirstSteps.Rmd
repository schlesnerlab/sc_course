...
# Load samples.
mt_pattern <- "^MT-"
sample_path <- "/omics/groups/OE0436/internal/heyer/scourse/sc_course/data/filtered_feature_bc_matrix" # Path to where the count matrix from cellranger (either filtered or raw, your choice) is located.
...
sample_processed <- readRDS("../../data/GSE205771/GSM6226122_oligodendroglioma_seurat_object.rds")
Seurat::DefaultAssay(sample) <- "RNA"
#count_mat <- read

sample@meta.data$orig.ident %>% unique()
sample_processed <- sample_processed[,sample_processed$orig.ident == "OE0145-IDH_NCH6341" ]
...
> 🧭✨ Task: How many clusters did we find?
