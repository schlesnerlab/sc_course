...
sample_path <- "/omics/groups/OE0436/internal/heyer/scourse/sc_course/data/filtered/BT322.filtered_gene_matrices" 
sample <- Read10X(data.dir = sample_path) %>%
...
sample <- RunUMAP(sample, dims = seq_len(10), verbose = FALSE)
```
