...
In a Heatmap we can visualize clustering, to illustrate some of the expression differences between these. 
However it does not resolve issues due to the dimensionality of the dataset. 
...
To resolve this, we turn to dimensionality reduction techniques. 
